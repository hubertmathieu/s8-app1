...
def create_network(checkpoint_path):
    layers = [FullyConnectedLayer(784, 128), BatchNormalization(128, alpha=0.1), ReLU(), FullyConnectedLayer(128, 32), BatchNormalization(32, alpha=0.1), ReLU(), FullyConnectedLayer(32, 10)]
